...
def model_abs_abund_closure_from_2nd(parameters):
    ...
    if sum((gR<0) + (I_intra>=0)) == 0:
        ...
        predicted_moments = integrate.solve_ivp(eq_moments_abs_abund_closure_from_2nd, [0, t_simulated], init_abs_abund, args = (gR, I_p, I_n), t_eval = sampling_times, method = 'LSODA', events=stopping_event_abs_abund)
