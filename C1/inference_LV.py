...
db_path_abs_abund = "sqlite:///./data/C1_inference_abs_abund.db"
db_path_rel_abund = "sqlite:///./data/C1_inference_rel_abund.db"
...
with open('./C1_inference_parameters.pickle', 'wb') as f:
